...
import Card from '../../../components/cards/post_admin'
                ...
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-12 sm:col-span-10 mx-auto">
                        ...
                        {!loading ? posts?.map((post, index) => {
                            return <Card info={info} reload={LoadPost} description={post.description} image={post.image} link={post.link} title={post.title} key={index} />
                        }) :
