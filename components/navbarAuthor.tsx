            ...
            <nav
                ...
                <div className="menu w-full flex-grow lg:flex lg:items-center lg:w-auto lg:px-3 px-8">
                    <div className={`text-md font-bold text-${this.props?.info?.colors?.text?.color || this.props?.info?.colors?.text?.color } lg:flex-grow`}>
                        <Link href='/author/post'>
                            <a>
                                <button
                                    className={`block mt-4 lg:inline-block lg:mt-0 hover:text-${this.props?.info?.colors?.text?.shadow || this.props?.info?.colors?.text?.shadow || "gray-100"} font-semibold px-4 py-2 rounded mr-2`}>
                                    Posts
                                </button>
                            </a>
                        </Link>
